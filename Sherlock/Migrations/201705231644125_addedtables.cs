namespace Sherlock.Migrations
{
    ...
    public partial class addedtables : DbMigration
    {
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Votes", "LandmarkId", "dbo.Landmarks");
            DropForeignKey("dbo.AspNetUserRoles", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserLogins", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.Landmarks", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.Comments", "ApplicationUser_Id", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserClaims", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.Landmarks", "CategoryId", "dbo.Categories");
            DropIndex("dbo.AspNetRoles", "RoleNameIndex");
            DropIndex("dbo.Votes", new[] { "UserId" });
            DropIndex("dbo.Votes", new[] { "LandmarkId" });
            ...
            DropIndex("dbo.Landmarks", new[] { "CategoryId" });
            DropIndex("dbo.Landmarks", new[] { "UserId" });
